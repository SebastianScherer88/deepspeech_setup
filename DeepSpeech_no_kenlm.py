...
#    duration = end - start
#    print('Spent ', str(duration.seconds), ' seconds in "decode_with_lm"')
#    print('Exiting "decode_with_lm"')
...
def calculate_mean_edit_distance_and_loss(model_feeder, tower, dropout):
    ...
    # Beam search decode the batch with tensorflow only, no external language model shenanigans
